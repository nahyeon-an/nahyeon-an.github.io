...
라는게 문제의 핵심이었다.  
dp\[i]\[j] : words[0]의 앞 i개의 문자와 words[1]의 앞 j개의 문자를 사용하여 words[2]의 앞 i+j개의 문자로 구성된 문자열을 만들 수 있는지 저장  
...
dp\[i]\[j] : sub의 앞 i개의 문자와 coin의 앞 j개의 문자를 사용하여 t의 앞 i+j개의 문자로 구성된 문자열을 만들 수 있는지 저장  
