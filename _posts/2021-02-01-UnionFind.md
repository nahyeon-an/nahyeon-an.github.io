...
2. _"트리"로 표현_  
    ...
    (루트노드의 경우 자기 자신을 가리킴)    
    각 노드를 <span style="color:#16559a">*1차원 배열*</span>로 표현 (자신의 부모 번호를 저장)  
...
### 최적화 1 : 랭크에 의한 합치기 (Union by Rank)
 <span style="color:#fae4ce">*: 높이가 더 낮은 트리를 더 높은 트리 밑에 합침*</span>  
 1차원 배열 <span style="color:#16559a">*rank[]*</span> = 루트 노드인 경우 해당 트리의 높이를 저장하는 배열  
 <span style="color:#16559a">*두 트리의 높이가 같은 경우 합친 결과 트리의 높이를 +1*</span>    
